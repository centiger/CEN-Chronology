...
// v16: 인포그래픽 8. 연결탐험 원문 기반 데이터
const EVENT_EXPLORE = {
  "creation": [
    ["유월절", "피 흘린 어린양으로 구원을 예표", "출애굽기 12장"],
    ["성막", "하나님의 임재가 함께 하심", "출애굽기 25~40장"],
    ["십자가", "창조주 하나님이 구속을 이루심", "요한복음 3:16"],
    ["성찬", "새 언약의 시작과 하나님의 나라", "누가복음 22:19~20"]
  ],
  "adam-eve": [
    ["창조", "아담과 하와", ""],
    ["타락", "죄의 시작", ""],
    ["속죄의 시작", "가죽옷을 입힘", "창 3:21"],
    ["구속의 완성", "예수 그리스도", "롬 5:18-19"],
    ["새 창조", "영원한 생명", "계 21:1-4"]
  ],
  "eden-exile": [
    ["창조", "하나님의 나라", ""],
    ["타락", "죄의 시작", ""],
  ...
  "babel-tower": [
    ...
    ["이스라엘 민족 선택", "아브라함", ""],
    ["성막과 언약", "하나님과 동행", ""],
    ["예수 그리스도", "십자가로 하나되게 하심", ""],
    ["성령으로 하나된 교회", "모든 언어의 사람들", ""]
  ]
};
