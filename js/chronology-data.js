...
const CHRONOLOGY_VERSION = "v39-exodus-wilderness-expanded";
...
// v39 출애굽과 광야시대 핵심사건 상세 데이터
Object.assign(EVENTS, {
  "moses-birth": {
    title:"모세의 탄생", era:"출애굽과 광야", year:"BC 1526년경", scripture:"출애굽기 1~2장",
    place:"애굽 나일강 일대",
    people:["모세","요게벳","미리암","바로의 공주","바로"],
    summary:"이스라엘 백성이 애굽에서 번성하자 바로는 히브리 남자아이를 죽이라는 명령을 내렸고, 모세는 갈대상자에 담겨 나일강에 띄워진 뒤 바로의 공주에게 발견되어 왕궁에서 성장하게 됩니다.",
    core:["히브리 남자아이 학살 명령","갈대상자에 담긴 모세","바로의 공주가 모세 발견","친어머니 요게벳이 유모가 됨","애굽 왕궁에서 성장"],
    meaning:["하나님은 구원자를 미리 준비하심","절망적인 상황 속에서도 구원의 계획은 진행됨","세상의 권력보다 하나님의 섭리가 더 큼"],
    connect:["구원자 예비","예수의 유아 시절 보호","믿음의 어머니 요게벳"],
    visual:"나일강, 애굽 왕궁, 고센 지역",
    image:"assets/infographics/13_moses_birth.png"
  },
  "burning-bush": {
    title:"떨기나무 소명", era:"출애굽과 광야", year:"BC 1446년경", scripture:"출애굽기 3~4장",
    place:"호렙산, 미디안 광야",
    people:["모세","하나님","아론"],
    summary:"미디안 광야에서 양을 치던 모세는 불타지만 사라지지 않는 떨기나무를 보았고, 하나님은 그곳에서 모세를 부르셔서 이스라엘을 애굽에서 인도해 내라는 사명을 주셨습니다.",
    core:["떨기나무 불꽃","하나님의 음성","신을 벗으라는 명령","모세의 사명 부여","아론을 협력자로 세움"],
    meaning:["하나님은 평범한 사람을 부르셔서 사명을 맡기심","부르심은 두려움을 넘어 순종을 요구함","‘나는 스스로 있는 자’라는 하나님의 이름이 계시됨"],
    connect:["하나님의 이름 계시","선지자 소명","사명의 순종"],
    visual:"미디안 광야, 호렙산, 모세의 도피 경로",
    image:"assets/infographics/14_burning_bush.png"
  },
  "ten-plagues": {
    title:"애굽의 10가지 재앙", era:"출애굽과 광야", year:"BC 1446년경", scripture:"출애굽기 7~12장",
    place:"애굽 전역",
    people:["모세","아론","바로"],
    summary:"바로가 이스라엘 백성을 보내지 않자 하나님은 애굽에 열 가지 재앙을 내리셨고, 마지막 장자의 죽음 이후 바로는 결국 출애굽을 허락합니다.",
    core:["나일강이 피가 됨","개구리·이·파리 재앙","가축 전염병과 악성 종기","우박과 메뚜기","흑암","장자의 죽음"],
    meaning:["하나님은 애굽의 신들과 권세를 심판하심","완악한 마음의 결과는 심판임","하나님의 구원은 심판과 함께 나타남"],
    connect:["심판과 구원","유월절","어린양의 피"],
    visual:"애굽 지도, 나일강, 바로 궁전",
    image:"assets/infographics/15_ten_plagues.png"
  },
  "passover": {
    title:"유월절", era:"출애굽과 광야", year:"BC 1446년경", scripture:"출애굽기 12장",
    place:"애굽 고센 지역",
    people:["모세","이스라엘 백성","바로"],
    summary:"하나님은 어린양의 피를 문설주에 바른 집은 심판이 넘어가게 하셨고, 이 사건은 이스라엘 구원의 시작이자 유월절 절기의 근거가 되었습니다.",
    core:["흠 없는 어린양 준비","피를 문설주에 바름","장자의 죽음","이스라엘의 출애굽 시작"],
    meaning:["피를 통한 구원의 상징","예수 그리스도의 희생을 예표","믿음으로 순종하는 자가 구원을 얻음"],
    connect:["십자가","성찬식","하나님의 어린양"],
    visual:"고센 지역, 유월절 식사, 문설주 피 표시",
    image:"assets/infographics/16_passover.png"
  },
  "red-sea": {
    title:"홍해의 기적", era:"출애굽과 광야", year:"BC 1446년경", scripture:"출애굽기 14~15장",
    place:"홍해",
    people:["모세","바로 군대","이스라엘 백성","미리암"],
    summary:"출애굽한 이스라엘 백성은 홍해 앞에서 애굽 군대를 만나 절망하지만 하나님은 바다를 가르셔서 백성을 건너게 하시고 애굽 군대를 물속에 잠기게 하셨습니다.",
    core:["홍해 앞 절망","모세의 지팡이","바다 갈라짐","이스라엘의 통과","애굽 군대 수장","미리암의 찬양"],
    meaning:["하나님은 불가능한 길을 여심","구원은 하나님의 능력으로 이루어짐","믿음은 두려움 속에서도 순종하는 것"],
    connect:["세례 상징","구원의 길","믿음과 순종"],
    visual:"홍해 추정 경로, 출애굽 이동 루트, 바다 갈라짐",
    image:"assets/infographics/17_red_sea.png"
  },
  "manna-quail": {
    title:"만나와 메추라기", era:"출애굽과 광야", year:"BC 1446년 이후 광야 시기", scripture:"출애굽기 16장",
    place:"신 광야",
    people:["모세","아론","이스라엘 백성"],
    summary:"광야에서 먹을 것이 없다고 원망하는 백성에게 하나님은 하늘의 만나와 메추라기를 내려 먹이셨습니다.",
    core:["백성의 원망","만나 공급","메추라기 공급","하루 분량을 거두는 훈련","안식일 규례"],
    meaning:["하나님은 광야에서도 공급하심","인간은 하나님께 의존해야 함","일용할 양식을 주시는 은혜를 보여줌"],
    connect:["생명의 떡","주기도문 일용할 양식","광야 훈련"],
    visual:"광야 이동 경로, 만나 형태, 광야 생활",
    image:"assets/infographics/18_manna_quail.png"
  },
  "sinai-commandments": {
    title:"시내산 십계명", era:"출애굽과 광야", year:"BC 1446년경", scripture:"출애굽기 19~20장",
    place:"시내산",
    people:["하나님","모세","이스라엘 백성"],
    summary:"하나님은 시내산에서 모세에게 십계명을 주시며 이스라엘과 언약을 맺으셨습니다.",
    core:["시내산 강림","십계명 수여","언약 체결","백성의 두려움","거룩한 백성으로 부르심"],
    meaning:["하나님의 백성은 거룩한 삶을 살아야 함","십계명은 하나님과 인간 관계의 기준","언약 공동체의 정체성을 세우심"],
    connect:["율법","언약","산상수훈"],
    visual:"시내산 위치, 십계명 석판, 언약 체결 장면",
    image:"assets/infographics/19_sinai_commandments.png"
  },
  "golden-calf": {
    title:"금송아지 사건", era:"출애굽과 광야", year:"BC 1446년경", scripture:"출애굽기 32장",
    place:"시내산 아래",
    people:["모세","아론","이스라엘 백성"],
    summary:"모세가 산에 올라간 동안 백성은 금송아지를 만들어 우상숭배를 했고, 모세는 내려와 돌판을 깨뜨리며 백성의 죄를 책망했습니다.",
    core:["금송아지 제작","우상숭배 축제","모세의 하산","돌판 파괴","레위인의 심판","모세의 중보"],
    meaning:["인간은 쉽게 하나님을 떠남","우상숭배는 언약 파괴임","중보자의 역할이 중요함"],
    connect:["우상숭배 경고","회개","중보기도"],
    visual:"시내산 진영, 금송아지, 깨진 돌판",
    image:"assets/infographics/20_golden_calf.png"
  },
  "tabernacle": {
    title:"성막 건축", era:"출애굽과 광야", year:"광야 생활 초기", scripture:"출애굽기 25~40장",
    place:"시내산 광야",
    people:["모세","브살렐","오홀리압","이스라엘 백성"],
    summary:"하나님은 이스라엘 가운데 거하시기 위해 성막 건축을 명령하셨고, 백성은 자원하여 재료를 드려 하나님의 임재 처소를 세웠습니다.",
    core:["성막 설계","자원 예물","브살렐과 오홀리압의 제작","언약궤와 기구 제작","성막 완성","하나님의 영광 충만"],
    meaning:["하나님은 백성과 함께 거하시길 원하심","성막은 예배와 거룩의 중심","예수 그리스도의 임재를 예표함"],
    connect:["성전","예배","임마누엘"],
    visual:"성막 구조도, 성막 배치도, 성막 기구",
    image:"assets/infographics/21_tabernacle.png"
  },
  "wilderness-40": {
    title:"광야 40년", era:"출애굽과 광야", year:"BC 1446~1406년", scripture:"민수기 13~14장",
    place:"시내 광야와 가데스 바네아",
    people:["모세","여호수아","갈렙","이스라엘 백성"],
    summary:"가나안 정탐 후 백성은 하나님을 불신하고 원망했고, 하나님은 불순종한 세대가 광야에서 40년을 보내게 하시며 새로운 세대를 준비하셨습니다.",
    core:["가나안 정탐","열 정탐꾼의 부정적 보고","여호수아와 갈렙의 믿음","백성의 원망과 불신앙","40년 방황 선고","새 세대 준비"],
    meaning:["불신앙은 약속의 땅을 잃게 함","광야는 훈련과 연단의 시간","하나님은 순종하는 새 세대를 세우심"],
    connect:["믿음과 순종","광야 훈련","천국 여정 비유"],
    visual:"광야 이동 지도, 가데스 바네아, 출애굽 전체 경로",
    image:"assets/infographics/22_wilderness_40.png"
  },
  "bronze-serpent": {
    title:"놋뱀 사건", era:"출애굽과 광야", year:"광야 후기", scripture:"민수기 21장",
    place:"에돔 주변 광야",
    people:["모세","이스라엘 백성"],
    summary:"백성이 하나님과 모세를 원망하자 불뱀이 나타나 많은 사람이 죽게 되었고, 하나님은 놋뱀을 장대에 달게 하셔서 그것을 바라보는 자마다 살게 하셨습니다.",
    core:["백성의 원망","불뱀 심판","백성의 회개 요청","놋뱀 제작","바라본 자의 회복"],
    meaning:["죄의 결과는 죽음임","믿음으로 바라볼 때 구원이 주어짐","십자가의 예표 사건"],
    connect:["십자가","믿음으로 얻는 구원","요한복음 3장"],
    visual:"광야 후기 이동 경로, 놋뱀 장면, 불뱀 사건",
    image:"assets/infographics/23_bronze_serpent.png"
  }
});

Object.assign(EVENT_ENRICH, {
  "moses-birth": {flowTitle:"핵심사건 흐름", flow:[["학살 명령","히브리 남자아이 학살 명령",""],["갈대상자","요게벳이 모세를 갈대상자에 담아 나일강에 둠",""],["미리암","미리암이 멀리서 지켜봄",""],["공주의 발견","바로의 공주가 모세를 발견함",""],["유모가 된 어머니","요게벳이 유모가 되어 모세를 기름",""],["왕궁 성장","모세가 애굽 왕궁에서 성장함",""]], scriptureRefs:[["출애굽기 1장","이스라엘의 번성과 바로의 박해"],["출애굽기 2장","모세의 탄생과 성장"]], visualItems:["나일강 위치","애굽 왕궁 추정 지역","고센 지도"]},
  "burning-bush": {flowTitle:"핵심사건 흐름", flow:[["미디안 광야","모세가 미디안 광야에서 양을 침",""],["떨기나무","불타지만 사라지지 않는 떨기나무를 봄",""],["거룩한 부르심","하나님이 거룩한 땅에서 모세를 부르심",""],["구원 사명","이스라엘 구원의 사명을 주심",""],["아론 동역","아론을 협력자로 세우심",""]], scriptureRefs:[["출애굽기 3장","하나님의 이름 계시와 모세의 소명"],["출애굽기 4장","모세의 주저함과 아론의 동역"]], visualItems:["미디안 광야","호렙산","모세 도피 경로"]},
  "ten-plagues": {flowTitle:"10가지 재앙", flow:[["피","나일강이 피로 변함",""],["개구리","개구리가 애굽 온 땅에 올라옴",""],["이","땅의 티끌이 이가 됨",""],["파리","파리 떼가 애굽에 가득함",""],["가축 전염병","애굽의 가축에게 전염병이 임함",""],["악성 종기","사람과 짐승에게 악성 종기가 생김",""],["우박","우박과 불이 내려 밭의 것을 침",""],["메뚜기","메뚜기가 남은 식물을 먹어 치움",""],["흑암","애굽 땅에 짙은 어둠이 임함",""],["장자의 죽음","애굽의 처음 난 것이 죽임을 당함",""]], scriptureRefs:[["출애굽기 7~12장","애굽에 내려진 열 가지 재앙"]], visualItems:["재앙 발생 지역","애굽 지도","바로 궁전"]},
  "passover": {flowTitle:"핵심사건 흐름", flow:[["어린양 준비","흠 없는 어린양을 준비함",""],["피 표시","피를 문설주와 인방에 바름",""],["출발 준비","어린양을 먹고 출발 준비를 함",""],["장자 심판","장자의 죽음 심판이 임함",""],["심판 넘어감","피가 있는 집은 심판이 넘어감",""],["출애굽 시작","출애굽이 시작됨",""]], scriptureRefs:[["출애굽기 12장","유월절과 출애굽 시작"],["요한복음 1:29","하나님의 어린양"],["고린도전서 5:7","그리스도는 유월절 양"]], visualItems:["고센 지역","유월절 식사 재현","문설주 피 표시"]},
  "red-sea": {flowTitle:"핵심사건 흐름", flow:[["홍해 앞","이스라엘이 홍해 앞에 이름",""],["추격","애굽 군대가 추격함",""],["바다 갈라짐","하나님이 바다를 가르심",""],["마른 땅 통과","이스라엘이 마른 땅으로 건넘",""],["애굽 군대 수장","애굽 군대가 물에 잠김",""],["승리 찬양","모세와 미리암의 찬양",""]], scriptureRefs:[["출애굽기 14장","홍해 도하"],["출애굽기 15장","모세와 미리암의 찬양"],["고린도전서 10:1-2","홍해와 세례의 연결"]], visualItems:["홍해 추정 경로","출애굽 이동 루트","바다 갈라짐"]},
  "manna-quail": {flowTitle:"핵심사건 흐름", flow:[["백성의 원망","백성이 먹을 것을 두고 원망함",""],["만나 공급","하나님이 만나를 내려 주심",""],["메추라기 공급","저녁에는 메추라기를 공급하심",""],["하루 분량","하루 분량만 거두게 하심",""],["안식일 훈련","안식일 전날에는 두 배를 거두게 하심",""]], scriptureRefs:[["출애굽기 16장","만나와 메추라기"],["요한복음 6장","예수님은 생명의 떡"]], visualItems:["광야 이동 경로","만나 형태","광야 생활 이미지"]},
  "sinai-commandments": {flowTitle:"핵심사건 흐름", flow:[["시내산 도착","이스라엘이 시내산에 도착함",""],["하나님 강림","하나님이 산에 강림하심",""],["십계명 선포","십계명이 선포됨",""],["언약 기준","언약 백성의 기준이 세워짐",""],["백성의 응답","백성이 두려움 가운데 응답함",""]], scriptureRefs:[["출애굽기 19장","시내산 언약 준비"],["출애굽기 20장","십계명 수여"],["마태복음 5~7장","산상수훈과 율법의 완성"]], visualItems:["시내산 위치","십계명 석판","언약 체결 장면"]},
  "golden-calf": {flowTitle:"핵심사건 흐름", flow:[["모세의 지체","모세가 산에 오래 머묾",""],["신 요구","백성이 아론에게 신을 만들라고 요구함",""],["금송아지 숭배","금송아지를 만들고 숭배함",""],["돌판 파괴","모세가 내려와 돌판을 깨뜨림",""],["죄의 심판","죄에 대한 심판이 임함",""],["모세의 중보","모세가 백성을 위해 중보함",""]], scriptureRefs:[["출애굽기 32장","금송아지 사건"],["신명기 9장","모세의 회고와 중보"]], visualItems:["시내산 진영 구조","금송아지","깨진 돌판"]},
  "tabernacle": {flowTitle:"핵심사건 흐름", flow:[["성막 설계","하나님이 성막 설계를 알려 주심",""],["자원 예물","백성이 자원하여 재료를 드림",""],["기술자 세움","브살렐과 오홀리압이 제작을 맡음",""],["기구 제작","언약궤와 기구들이 제작됨",""],["성막 완성","성막이 세워짐",""],["영광 충만","하나님의 영광이 성막에 충만함",""]], scriptureRefs:[["출애굽기 25~31장","성막 설계 명령"],["출애굽기 35~40장","성막 제작과 완성"],["요한복음 1:14","말씀이 육신이 되어 우리 가운데 거하심"]], visualItems:["성막 구조도","성막 배치도","성막 기구 설명"]},
  "wilderness-40": {flowTitle:"핵심사건 흐름", flow:[["정탐꾼 파송","가나안 정탐꾼 12명을 보냄",""],["두려움의 보고","열 정탐꾼이 두려움의 보고를 함",""],["믿음의 보고","여호수아와 갈렙은 믿음으로 말함",""],["원망과 불신앙","백성이 원망하고 불신앙을 드러냄",""],["40년 선고","광야 40년 방황이 선고됨",""],["새 세대 준비","새 세대가 준비됨",""]], scriptureRefs:[["민수기 13장","가나안 정탐"],["민수기 14장","불신앙과 40년 방황"],["히브리서 3~4장","불순종의 경고와 안식"]], visualItems:["광야 이동 지도","가데스 바네아 위치","출애굽 전체 경로"]},
  "bronze-serpent": {flowTitle:"핵심사건 흐름", flow:[["마음이 상함","백성이 길로 인해 마음이 상함",""],["원망","하나님과 모세를 원망함",""],["불뱀 심판","불뱀 심판이 임함",""],["죄 고백","백성이 죄를 고백하고 중보를 요청함",""],["놋뱀을 듦","모세가 놋뱀을 장대에 달음",""],["바라봄과 회복","바라본 자가 살아남",""]], scriptureRefs:[["민수기 21장","놋뱀 사건"],["요한복음 3:14-15","인자도 들려야 하리니"],["고린도전서 10장","광야 사건의 교훈"]], visualItems:["광야 후기 이동 경로","놋뱀 장면","불뱀 사건"]}
});

Object.assign(EVENT_EXPLORE, {
  "moses-birth": {title:"8. 연결탐험", items:[{title:"구원자 예비", desc:"모세"},{title:"요게벳의 믿음", desc:"히 11장"},{title:"예수의 유아 보호", desc:"마 2장"},{title:"하나님의 섭리", desc:"왕궁 성장"}]},
  "burning-bush": {title:"8. 연결탐험", items:[{title:"하나님의 이름", desc:"나는 스스로 있는 자"},{title:"선지자 소명", desc:"부르심"},{title:"출애굽 사명", desc:"구원"},{title:"순종", desc:"두려움을 넘어"}]},
  "ten-plagues": {title:"8. 연결탐험", items:[{title:"심판과 구원", desc:"재앙"},{title:"애굽 신들 심판", desc:"권세 대결"},{title:"유월절", desc:"마지막 재앙"},{title:"어린양의 피", desc:"구원 표지"}]},
  "passover": {title:"8. 연결탐험", items:[{title:"어린양", desc:"흠 없음"},{title:"피", desc:"심판이 넘어감"},{title:"십자가", desc:"그리스도"},{title:"성찬", desc:"새 언약"},{title:"구원", desc:"믿음과 순종"}]},
  "red-sea": {title:"8. 연결탐험", items:[{title:"출애굽", desc:"해방"},{title:"홍해", desc:"구원의 길"},{title:"세례", desc:"고전 10장"},{title:"찬양", desc:"모세와 미리암"}]},
  "manna-quail": {title:"8. 연결탐험", items:[{title:"일용할 양식", desc:"공급"},{title:"안식일", desc:"훈련"},{title:"생명의 떡", desc:"요 6장"},{title:"광야훈련", desc:"의존"}]},
  "sinai-commandments": {title:"8. 연결탐험", items:[{title:"시내산 언약", desc:"출 19장"},{title:"십계명", desc:"출 20장"},{title:"율법", desc:"거룩"},{title:"산상수훈", desc:"율법의 완성"}]},
  "golden-calf": {title:"8. 연결탐험", items:[{title:"우상숭배", desc:"언약 파괴"},{title:"돌판", desc:"깨짐"},{title:"회개", desc:"돌이킴"},{title:"중보기도", desc:"모세"}]},
  "tabernacle": {title:"8. 연결탐험", items:[{title:"성막", desc:"임재"},{title:"언약궤", desc:"하나님의 보좌"},{title:"성전", desc:"확장"},{title:"임마누엘", desc:"예수 그리스도"},{title:"예배", desc:"거룩"}]},
  "wilderness-40": {title:"8. 연결탐험", items:[{title:"가나안 정탐", desc:"믿음의 시험"},{title:"불신앙", desc:"원망"},{title:"광야훈련", desc:"40년"},{title:"새 세대", desc:"순종"}]},
  "bronze-serpent": {title:"8. 연결탐험", items:[{title:"불뱀", desc:"죄의 결과"},{title:"놋뱀", desc:"바라봄"},{title:"십자가", desc:"요 3장"},{title:"믿음의 구원", desc:"바라보는 자"}]}
});
...
Object.assign(EVENT_MAP_CROPS, {
  ...
  "wilderness-40":"assets/infographics/22_wilderness_40.png",
  "bronze-serpent":"assets/infographics/23_bronze_serpent.png"
});
