...
const CHRONOLOGY_VERSION = "v82-coreflow-requested-list-fix";
...
Object.assign(EVENTS, {
  ...
  "john-baptist": {
    ...
    meaning:["메시아의 길을 예비한 선지자적 사역", "회개와 인포그래픽 핵심사건 흐름 반영의 시작", "예수님의 공생애를 준비하는 전환점"],
...
"jesus-1":{
 ...
 people:["예수님"],
 summary:"가나 혼인잔치 사건",
 core:["인포그래픽 핵심사건 흐름 반영","인포그래픽 핵심사건 흐름 반영","인포그래픽 핵심사건 흐름 반영","인포그래픽 핵심사건 흐름 반영"],
...
"jesus-1":{
 ...
 flow:[
  ["사건 시작","가나 혼인잔치 인포그래픽 핵심사건 흐름 반영",""],
  ["가르침","인포그래픽 핵심사건 흐름 반영",""],
  ["반응","인포그래픽 핵심사건 흐름 반영",""],
  ["의미","인포그래픽 핵심사건 흐름 반영",""]
 ]
},
"jesus-2":{
 ...
 flow:[
  ["사건 시작","니고데모와의 대화 인포그래픽 핵심사건 흐름 반영",""],
  ["가르침","인포그래픽 핵심사건 흐름 반영",""],
  ["반응","인포그래픽 핵심사건 흐름 반영",""],
  ["의미","인포그래픽 핵심사건 흐름 반영",""]
 ]
...
"jesus-3":{
 ...
 flow:[
  ["사건 시작","사마리아 여인과의 대화 인포그래픽 핵심사건 흐름 반영",""],
  ["가르침","인포그래픽 핵심사건 흐름 반영",""],
  ["반응","인포그래픽 핵심사건 흐름 반영",""],
  ["의미","인포그래픽 핵심사건 흐름 반영",""]
 ]
...
"jesus-4":{
 ...
 flow:[
  ["사건 시작","예수님의 이적과 비유들 인포그래픽 핵심사건 흐름 반영",""],
  ["가르침","인포그래픽 핵심사건 흐름 반영",""],
  ["반응","인포그래픽 핵심사건 흐름 반영",""],
  ["의미","인포그래픽 핵심사건 흐름 반영",""]
 ]
...
"jesus-5":{
 ...
 flow:[
  ["사건 시작","성전 청결 사건 인포그래픽 핵심사건 흐름 반영",""],
  ["가르침","인포그래픽 핵심사건 흐름 반영",""],
  ["반응","인포그래픽 핵심사건 흐름 반영",""],
  ["의미","인포그래픽 핵심사건 흐름 반영",""]
 ]
...
"jesus-1":{
 ...
 items:[
  ...
  {title:"하나님 나라",desc:"인포그래픽 핵심사건 흐름 반영",ref:"복음서"}
 ]
},
"jesus-2":{
 title:"8. 연결탐험",
...
// v82 요청 목록 전체 6.핵심사건 제목/설명 전수 보정
Object.assign(EVENT_ENRICH,{
  "isaac-birth":{
    flowTitle:"핵심사건 흐름",
    flow:[
  ...
  "jacob-esau-birthright":{
    flowTitle:"핵심사건 흐름",
    flow:[
      ["쌍둥이 출생","리브가에게서 에서와 야곱이 태어남",""],
      ["에서의 피곤함","에서가 들에서 돌아와 심히 피곤하고 배고픈 상태가 됨",""],
      ["팥죽 거래","야곱이 팥죽을 주는 조건으로 장자권을 요구함",""],
      ["장자권 경시","에서가 장자권을 가볍게 여기고 야곱에게 팔아넘김",""],
      ["언약 계승의 긴장","장자권 사건이 이후 야곱의 언약 계승 흐름으로 이어짐",""]
    ]
  },
  "jacob-egypt-migration":{
    flowTitle:"핵심사건 흐름",
    flow:[
