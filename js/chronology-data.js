...
const CHRONOLOGY_VERSION = "v80-recent-core-text-audit-fix";
...
"jesus-1":{
 ...
 flow:[
  ...
  ["물 항아리","예수님이 하인들에게 항아리에 물을 채우라고 하심",""],
  ["첫 표적","물이 좋은 포도주로 변화되고 제자들이 믿음",""]
 ]
},
"jesus-2":{
...
// v79 예수 시대 핵심사건 6번 텍스트 보정: 인포그래픽 핵심사건 문장 반영
Object.assign(EVENTS,{
  "jesus-1":{
    title:"가나 혼인잔치", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 2:1~11",
    place:"갈릴리 가나",
    people:["예수님","마리아","제자들","연회장","하인들"],
    summary:"예수님이 가나 혼인잔치에서 물을 포도주로 바꾸신 첫 표적 사건입니다.",
    core:["갈릴리 가나의 혼인잔치에 예수님과 제자들이 초대됨","잔치 중 포도주가 떨어져 곤란한 상황이 생김","마리아가 예수님께 문제를 알림","예수님이 하인들에게 항아리에 물을 채우라고 하심","물이 좋은 포도주로 변화됨","제자들이 예수님의 영광을 보고 믿음"],
    meaning:["예수님의 첫 표적으로 영광이 드러남","순종을 통해 은혜와 풍성함이 나타남","예수님은 새 기쁨과 새 언약의 주인이심"],
    connect:["혼인잔치","새 포도주","순종","첫 표적","하나님 나라의 기쁨"],
    visual:"예수 시대 지도와 사건 장면",
    image:"assets/infographics/jesus-1.png"
  },
  "jesus-2":{
    title:"니고데모와의 대화", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 3:1~21",
    place:"예루살렘",
    people:["예수님","니고데모","성령","하나님","믿는 자"],
    summary:"예수님이 밤에 찾아온 니고데모에게 거듭남과 영생의 복음을 가르치신 사건입니다.",
    core:["바리새인 니고데모가 밤에 예수님을 찾아옴","예수님이 사람이 거듭나야 하나님 나라를 볼 수 있다고 말씀하심","물과 성령으로 나는 새 생명을 설명하심","모세가 광야에서 놋뱀을 든 사건을 연결하심","하나님이 세상을 사랑하셔서 독생자를 주셨음을 선포하심","빛과 어둠, 믿음과 심판의 갈림길을 말씀하심"],
    meaning:["구원은 혈통이나 지식이 아니라 성령으로 거듭나는 것임","예수님을 믿는 자에게 영생이 주어짐","하나님의 사랑과 복음의 핵심이 드러남"],
    connect:["거듭남","성령","놋뱀","영생","요한복음 3:16"],
    visual:"예수 시대 지도와 사건 장면",
    image:"assets/infographics/jesus-2.png"
  },
  "jesus-3":{
    title:"사마리아 여인과의 대화", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 4:1~42",
    place:"사마리아 수가성 야곱의 우물",
    people:["예수님","사마리아 여인","제자들","수가성 사람들"],
    summary:"예수님이 사마리아 여인에게 생수와 참된 예배를 가르치시고, 사마리아 사람들이 예수님을 구주로 믿게 된 사건입니다.",
    core:["예수님이 사마리아 수가성 야곱의 우물에 이르심","사마리아 여인에게 물을 달라고 하심","예수님이 영원히 목마르지 않는 생수를 말씀하심","여인의 삶을 드러내시며 회개와 믿음으로 이끄심","영과 진리로 드리는 참된 예배를 가르치심","여인이 마을에 전하고 많은 사마리아 사람들이 예수님을 믿음"],
    meaning:["복음은 유대인을 넘어 사마리아와 모든 민족에게 열림","예수님은 영혼의 목마름을 해결하는 생수이심","참된 예배는 장소가 아니라 영과 진리로 드리는 것임"],
    connect:["생수","참된 예배","사마리아","복음 확장","구주"],
    visual:"예수 시대 지도와 사건 장면",
    image:"assets/infographics/jesus-3.png"
  },
  "jesus-4":{
    title:"예수님의 이적과 비유들", era:"예수 시대", year:"AD 27~30년경", scripture:"마태복음·마가복음·누가복음·요한복음",
    place:"갈릴리, 유대, 사마리아 등",
    people:["예수님","제자들","무리","병자들","종교지도자들"],
    summary:"예수님이 이적과 비유를 통해 하나님 나라의 능력과 의미를 보여주신 사역입니다.",
    core:["병든 자를 고치시고 귀신을 쫓아내심","자연을 다스리시고 죽은 자를 살리심","오병이어와 여러 표적으로 하나님의 공급을 보여주심","씨 뿌리는 자, 탕자, 선한 사마리아인 등 비유로 하나님 나라를 설명하심","이적은 예수님이 메시아이심을 드러내는 표적이 됨","비유는 듣는 자의 마음을 드러내고 믿음의 결단을 요구함"],
    meaning:["이적은 예수님의 권위와 하나님 나라의 능력을 보여줌","비유는 하나님 나라의 비밀을 일상 언어로 가르침","예수님의 사역은 십자가와 부활을 향해 나아감"],
    connect:["하나님 나라","표적","비유","믿음","메시아"],
    visual:"예수 시대 지도와 사건 장면",
    image:"assets/infographics/jesus-4.png"
  },
  "jesus-5":{
    title:"성전 청결 사건", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 2:13~22 / 마태복음 21:12~17",
    place:"예루살렘 성전",
    people:["예수님","제자들","상인들","환전상들","종교지도자들"],
    summary:"예수님이 성전을 장사하는 곳으로 만든 사람들을 내쫓으시며 성전의 참된 의미를 드러내신 사건입니다.",
    core:["예수님이 유월절에 예루살렘 성전에 올라가심","성전 안에서 소와 양과 비둘기 파는 자들과 환전상들을 보심","예수님이 그들을 내쫓고 상을 엎으심","성전을 장사하는 집으로 만들지 말라고 책망하심","제자들이 주의 전을 사모하는 열심을 기억함","예수님이 자신의 몸을 참 성전으로 가리켜 말씀하심"],
    meaning:["성전은 장사와 이익의 장소가 아니라 기도와 예배의 장소임","예수님은 성전보다 크신 참 성전이심","십자가와 부활을 통해 하나님께 나아가는 길이 열림"],
    connect:["성전","유월절","예배 회복","참 성전","십자가와 부활"],
    visual:"예수 시대 지도와 사건 장면",
    image:"assets/infographics/jesus-5.png"
  }
});
Object.assign(EVENT_ENRICH,{
  "jesus-1":{
    flowTitle:"가나 혼인잔치 핵심사건 흐름",
    flow:[
      ["갈릴리 가나의 혼인잔치에 예수님과 제자들이 초대됨","갈릴리 가나의 혼인잔치에 예수님과 제자들이 초대됨",""],
      ["잔치 중 포도주가 떨어져 곤란한 상황이 생김","잔치 중 포도주가 떨어져 곤란한 상황이 생김",""],
      ["마리아가 예수님께 문제를 알림","마리아가 예수님께 문제를 알림",""],
      ["예수님이 하인들에게 항아리에 물을 채우라고 하심","예수님이 하인들에게 항아리에 물을 채우라고 하심",""],
      ["물이 좋은 포도주로 변화됨","물이 좋은 포도주로 변화됨",""],
      ["제자들이 예수님의 영광을 보고 믿음","제자들이 예수님의 영광을 보고 믿음",""]
    ],
    scriptureRefs:[
      ["요한복음 2:1~11","예수님이 가나 혼인잔치에서 물을 포도주로 바꾸신 첫 표적 사건입니다."]
    ],
    visualItems:["지도/시각자료","사건 장면","핵심 의미"]
  },
  "jesus-2":{
    flowTitle:"니고데모와의 대화 핵심사건 흐름",
    flow:[
      ["바리새인 니고데모가 밤에 예수님을 찾아옴","바리새인 니고데모가 밤에 예수님을 찾아옴",""],
      ["예수님이 사람이 거듭나야 하나님 나라를 볼 수 있다고 말씀하심","예수님이 사람이 거듭나야 하나님 나라를 볼 수 있다고 말씀하심",""],
      ["물과 성령으로 나는 새 생명을 설명하심","물과 성령으로 나는 새 생명을 설명하심",""],
      ["모세가 광야에서 놋뱀을 든 사건을 연결하심","모세가 광야에서 놋뱀을 든 사건을 연결하심",""],
      ["하나님이 세상을 사랑하셔서 독생자를 주셨음을 선포하심","하나님이 세상을 사랑하셔서 독생자를 주셨음을 선포하심",""],
      ["빛과 어둠, 믿음과 심판의 갈림길을 말씀하심","빛과 어둠, 믿음과 심판의 갈림길을 말씀하심",""]
    ],
    scriptureRefs:[
      ["요한복음 3:1~21","예수님이 밤에 찾아온 니고데모에게 거듭남과 영생의 복음을 가르치신 사건입니다."]
    ],
    visualItems:["지도/시각자료","사건 장면","핵심 의미"]
  },
  "jesus-3":{
    flowTitle:"사마리아 여인과의 대화 핵심사건 흐름",
    flow:[
      ["예수님이 사마리아 수가성 야곱의 우물에 이르심","예수님이 사마리아 수가성 야곱의 우물에 이르심",""],
      ["사마리아 여인에게 물을 달라고 하심","사마리아 여인에게 물을 달라고 하심",""],
      ["예수님이 영원히 목마르지 않는 생수를 말씀하심","예수님이 영원히 목마르지 않는 생수를 말씀하심",""],
      ["여인의 삶을 드러내시며 회개와 믿음으로 이끄심","여인의 삶을 드러내시며 회개와 믿음으로 이끄심",""],
      ["영과 진리로 드리는 참된 예배를 가르치심","영과 진리로 드리는 참된 예배를 가르치심",""],
      ["여인이 마을에 전하고 많은 사마리아 사람들이 예수님을 믿음","여인이 마을에 전하고 많은 사마리아 사람들이 예수님을 믿음",""]
    ],
    scriptureRefs:[
      ["요한복음 4:1~42","예수님이 사마리아 여인에게 생수와 참된 예배를 가르치시고, 사마리아 사람들이 예수님을 구주로 믿게 된 사건입니다."]
    ],
    visualItems:["지도/시각자료","사건 장면","핵심 의미"]
  },
  "jesus-4":{
    flowTitle:"예수님의 이적과 비유들 핵심사건 흐름",
    flow:[
      ["병든 자를 고치시고 귀신을 쫓아내심","병든 자를 고치시고 귀신을 쫓아내심",""],
      ["자연을 다스리시고 죽은 자를 살리심","자연을 다스리시고 죽은 자를 살리심",""],
      ["오병이어와 여러 표적으로 하나님의 공급을 보여주심","오병이어와 여러 표적으로 하나님의 공급을 보여주심",""],
      ["씨 뿌리는 자, 탕자, 선한 사마리아인 등 비유로 하나님 나라를 설명하심","씨 뿌리는 자, 탕자, 선한 사마리아인 등 비유로 하나님 나라를 설명하심",""],
      ["이적은 예수님이 메시아이심을 드러내는 표적이 됨","이적은 예수님이 메시아이심을 드러내는 표적이 됨",""],
      ["비유는 듣는 자의 마음을 드러내고 믿음의 결단을 요구함","비유는 듣는 자의 마음을 드러내고 믿음의 결단을 요구함",""]
    ],
    scriptureRefs:[
      ["마태복음·마가복음·누가복음·요한복음","예수님이 이적과 비유를 통해 하나님 나라의 능력과 의미를 보여주신 사역입니다."]
    ],
    visualItems:["지도/시각자료","사건 장면","핵심 의미"]
  },
  "jesus-5":{
    flowTitle:"성전 청결 사건 핵심사건 흐름",
    flow:[
      ["예수님이 유월절에 예루살렘 성전에 올라가심","예수님이 유월절에 예루살렘 성전에 올라가심",""],
      ["성전 안에서 소와 양과 비둘기 파는 자들과 환전상들을 보심","성전 안에서 소와 양과 비둘기 파는 자들과 환전상들을 보심",""],
      ["예수님이 그들을 내쫓고 상을 엎으심","예수님이 그들을 내쫓고 상을 엎으심",""],
      ["성전을 장사하는 집으로 만들지 말라고 책망하심","성전을 장사하는 집으로 만들지 말라고 책망하심",""],
      ["제자들이 주의 전을 사모하는 열심을 기억함","제자들이 주의 전을 사모하는 열심을 기억함",""],
      ["예수님이 자신의 몸을 참 성전으로 가리켜 말씀하심","예수님이 자신의 몸을 참 성전으로 가리켜 말씀하심",""]
    ],
    scriptureRefs:[
      ["요한복음 2:13~22 / 마태복음 21:12~17","예수님이 성전을 장사하는 곳으로 만든 사람들을 내쫓으시며 성전의 참된 의미를 드러내신 사건입니다."]
    ],
    visualItems:["지도/시각자료","사건 장면","핵심 의미"]
  }
});
Object.assign(EVENT_EXPLORE,{
  "jesus-1":{
    ...
    items:[
      ...
      {title:"순종",desc:"예수님의 사역과 연결",ref:"복음서"},
      {title:"하나님 나라의 기쁨",desc:"믿음의 적용",ref:"복음서"}
    ]
  },
  "jesus-2":{
    title:"8. 연결탐험",
    items:[
      ...
      {title:"놋뱀",desc:"예수님의 사역과 연결",ref:"복음서"},
      {title:"요한복음 3:16",desc:"믿음의 적용",ref:"복음서"}
    ]
  },
  "jesus-3":{
    title:"8. 연결탐험",
    items:[
      ...
      {title:"사마리아",desc:"예수님의 사역과 연결",ref:"복음서"},
      {title:"구주",desc:"믿음의 적용",ref:"복음서"}
    ]
  },
  "jesus-4":{
    title:"8. 연결탐험",
    items:[
      ...
      {title:"비유",desc:"예수님의 사역과 연결",ref:"복음서"},
      {title:"메시아",desc:"믿음의 적용",ref:"복음서"}
    ]
  },
  "jesus-5":{
    title:"8. 연결탐험",
    items:[
      ...
      {title:"예배 회복",desc:"예수님의 사역과 연결",ref:"복음서"},
      {title:"십자가와 부활",desc:"믿음의 적용",ref:"복음서"}
    ]
  }
});


// v80 최근 추가 핵심사건 6번 핵심사건 텍스트 전수 보정
Object.assign(EVENTS,{
  "saul-disobedience":{
    title:"사울왕의 불순종과 버림받음", era:"통일왕국", year:"BC 1050경 이후", scripture:"사무엘상 13장, 15장",
    place:"길갈, 아말렉 전쟁 지역",
    people:["사울","사무엘","아말렉","이스라엘 백성"],
    summary:"사울 왕이 하나님의 명령을 온전히 순종하지 않고 자기 판단과 체면을 앞세우다가 왕위가 하나님께 버림받는 사건입니다.",
    core:["권한 침범","불순종 반복","변명","책망","버림받음"],
    meaning:["불완전한 순종은 불순종임","왕도 하나님의 말씀 아래 있어야 함","참된 왕은 말씀에 온전히 순종하는 분이어야 함"],
    connect:["순종","제사","왕권","다윗 선택","그리스도의 순종"],
    visual:"길갈과 아말렉 전쟁 개념도",
    image:"assets/infographics/118_saul_disobedience.png"
  ...
  "david-fugitive-life":{
    title:"다윗의 도피생활", era:"통일왕국", year:"BC 1020경", scripture:"사무엘상 18~31장",
    place:"놉, 아둘람, 엔게디, 십 광야, 블레셋 지역",
    people:["다윗","사울","요나단","아비아달","아비가일"],
    summary:"다윗이 사울의 추격을 피해 광야와 여러 지역을 떠돌며 하나님의 때를 기다린 사건입니다.",
    core:["사울의 시기","요나단의 도움","광야 도피","보복 거절","왕국 준비"],
    meaning:["하나님의 약속은 고난 속에서 준비됨","다윗은 보복보다 하나님의 때를 기다림","고난의 왕 다윗은 그리스도의 낮아지심을 예표함"],
    connect:["기름부음","광야","고난","하나님의 때","그리스도 왕권"],
    visual:"다윗 도피 경로 지도",
    image:"assets/infographics/119_david_fugitive_life.png"
  ...
  "absalom-rebellion":{
    title:"압살롬의 반역", era:"통일왕국", year:"BC 980경", scripture:"사무엘하 13~19장",
    place:"예루살렘, 헤브론, 마하나임, 에브라임 수풀",
    people:["다윗","압살롬","요압","후새","아히도벨"],
    summary:"다윗의 아들 압살롬이 백성의 마음을 훔쳐 반역을 일으키고 다윗이 예루살렘을 떠나 피신한 사건입니다.",
    core:["가정의 균열","민심 장악","반역 선포","다윗 피신","반역 진압"],
    meaning:["죄의 결과가 가정과 나라에 영향을 미침","권력욕은 공동체를 분열시킴","다윗의 슬픔은 심판 속에서도 자비를 갈망하는 마음을 보여줌"],
    connect:["다윗 언약","죄의 결과","반역","왕의 눈물","그리스도의 자비"],
    visual:"예루살렘-헤브론-마하나임 이동 지도",
    image:"assets/infographics/120_absalom_rebellion.png"
  ...
  "ahab-jezebel-idolatry":{
    title:"아합왕과 이세벨의 우상숭배", era:"분열왕국", year:"BC 874~853경", scripture:"열왕기상 16~18장, 21장",
    place:"북이스라엘 사마리아, 이스르엘, 갈멜산",
    people:["아합","이세벨","엘리야","바알 선지자들","나봇"],
    summary:"북이스라엘 아합 왕과 이세벨이 바알 숭배를 국가적으로 확산시키며 이스라엘의 영적 타락을 심화시킨 사건입니다.",
    core:["바알 숭배 도입","우상 제단 건립","선지자 박해","가뭄 심판","갈멜산 대결","나봇 사건"],
    meaning:["우상숭배는 개인 문제가 아니라 공동체 전체를 무너뜨림","하나님은 타락한 권력과 거짓 예배를 심판하심","참된 예배와 말씀의 회복이 필요함"],
    connect:["우상숭배","바알","엘리야","갈멜산","참된 예배"],
    visual:"사마리아·이스르엘·갈멜산 위치 지도",
    image:"assets/infographics/121_ahab_jezebel_idolatry.png"
  ...
  "naaman-healing":{
    title:"나아만 장군의 문둥병 치유", era:"분열왕국", year:"BC 850경", scripture:"열왕기하 5장",
    place:"아람, 사마리아, 요단강",
    people:["나아만","엘리사","이스라엘 소녀","게하시","아람 왕"],
    summary:"아람의 군대장관 나아만이 엘리사의 말에 순종하여 요단강에 일곱 번 몸을 씻고 나병에서 치유된 사건입니다.",
    core:["고통","소녀의 증언","엘리사 방문","요단강 순종","치유와 고백","게하시의 탐욕"],
    meaning:["하나님의 은혜는 이방인에게도 열려 있음","치유는 화려한 의식보다 말씀에 대한 겸손한 순종에서 나타남","하나님 앞에서는 지위보다 믿음과 순종이 중요함"],
    connect:["요단강","이방인 은혜","말씀 순종","치유","참 하나님 고백"],
    visual:"아람-사마리아-요단강 이동 지도",
    image:"assets/infographics/122_naaman_healing.png"
  },
  "cyrus-decree":{
    title:"고레스 왕의 조서", era:"유다멸망과 포로", year:"BC 539년경", scripture:"에스라 1장 / 역대하 36:22-23",
    place:"바벨론 → 예루살렘",
    people:["고레스 왕","여호와 하나님","유다 백성","스룹바벨","선지자들"],
    summary:"바사 왕 고레스가 포로 된 유다 백성에게 예루살렘 귀환과 성전 재건을 허락한 사건입니다.",
    core:["바벨론 멸망","조서 선포","성전 기물 반환","귀환 준비","회복 시작"],
    meaning:["하나님은 이방 왕도 사용하심","예언된 회복이 시작됨","성전 재건과 예배 회복의 길이 열림"],
    connect:["하나님의 주권","예언 성취","귀환","성전 재건","회복"],
    visual:"바사 제국과 예루살렘 귀환 경로",
    image:"assets/infographics/123_cyrus_decree.png"
  ...
  "haggai-zechariah-encouragement":{
    title:"학개와 스가랴 선지자의 독려", era:"포로귀환", year:"BC 520년경", scripture:"에스라 5~6장 / 학개 1~2장 / 스가랴 1~8장",
    place:"예루살렘",
    people:["학개","스가랴","스룹바벨","여호수아","귀환 백성"],
    summary:"성전 재건이 중단된 귀환 공동체에게 학개와 스가랴가 하나님의 말씀으로 다시 일어나 성전을 완공하도록 격려한 사건입니다.",
    core:["성전 공사 중단","학개의 책망","백성의 순종","스가랴의 환상","성전 재건 재개","성전 완공"],
    meaning:["말씀의 독려가 낙심한 공동체를 다시 일으킴","예배 회복은 귀환 공동체의 중심 과제임","성전 재건은 장차 오실 메시아 소망과 연결됨"],
    connect:["성전 재건","예배 회복","스룹바벨","여호수아","메시아 소망"],
    visual:"예루살렘 성전 재건 현장과 페르시아 시대 지도",
    image:"assets/infographics/124_haggai_zechariah_encouragement.png"
  },
  "malachi-warning":{
    title:"말라기 선지자의 경고", era:"포로귀환", year:"BC 5세기 중반경", scripture:"말라기 1~4장",
    place:"예루살렘과 유다",
    people:["말라기","제사장들","백성들","레위 자손들","엘리야"],
    summary:"포로귀환 이후 성전은 재건되었지만 백성들의 신앙이 형식화되자 말라기 선지자가 제사장과 백성의 타락을 책망하고 회개와 메시아 소망을 선포한 사건입니다.",
    core:["제사 타락 책망","제사장들의 죄 책망","언약 불순종 지적","십일조와 제물 경고","의인과 악인의 구별","여호와의 사자와 의의 해 예언","엘리야의 사명 예언"],
    meaning:["형식적 신앙의 위험을 경고함","언약 백성의 마음 회복과 순종을 촉구함","심판과 함께 회복과 축복의 약속을 선포함","장차 오실 메시아와 엘리야의 사역을 예언함"],
    connect:["언약","회개","예배 회복","십일조","의의 해","메시아","엘리야"],
    visual:"페르시아 제국 지도와 예루살렘 위치",
    image:"assets/infographics/125_malachi_warning.png"
  ...
  "septuagint-translation":{
    title:"70인역 성경번역", era:"신구약 중간기", year:"BC 3세기경", scripture:"구약성경의 헬라어 번역 전통",
    place:"이집트 알렉산드리아",
    people:["유대 학자들","헬라어권 유대인","프톨레마이오스 왕조"],
    summary:"히브리어 성경이 헬라어로 번역되어 디아스포라 유대인과 헬라어권 세계에 하나님의 말씀이 널리 전해질 수 있게 된 사건입니다.",
    core:["디아스포라 확산","언어 변화","번역 추진","헬라어 성경 형성","말씀 접근 확대","복음 전파 준비"],
    meaning:["하나님의 말씀이 민족과 언어의 경계를 넘어 확장됨","신약 시대 복음 전파를 위한 언어적 토대가 마련됨","구약과 신약을 잇는 중요한 말씀 전달 사건임"],
    connect:["헬라어","디아스포라","말씀 번역","복음 전파","신약 성경"],
    visual:"알렉산드리아와 지중해 헬라어권 세계 지도",
    image:"assets/infographics/126_septuagint_translation.png"
  },
  "herodian-rule-start":{
    title:"헤롯 왕가의 유대 통치 시작", era:"신구약 중간기", year:"BC 37년경 이후", scripture:"신약 배경사 / 마태복음 2장 배경",
    place:"유대, 예루살렘, 로마 제국",
    people:["헤롯 대왕","로마 황제","유대 백성","대제사장 세력"],
    summary:"로마의 후원을 받은 헤롯 왕가가 유대를 통치하기 시작하면서 신약 시대의 정치적 배경이 형성된 사건입니다.",
    core:["로마의 영향 확대","헤롯의 등극","유대 통치 강화","성전 증축","정치적 긴장","예수 탄생 배경"],
    meaning:["신약 시대의 정치적 배경을 이해하게 함","로마 지배와 헤롯 왕가의 통치 속에서 메시아 소망이 깊어짐","예수님의 탄생과 사역 배경을 준비함"],
    connect:["로마 제국","헤롯 왕가","성전 증축","메시아 대망","예수 탄생"],
    visual:"로마 제국과 유대 지역 지도",
    image:"assets/infographics/127_herodian_rule_start.png"
  },
  "jesus-1":{
    title:"가나 혼인잔치", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 2:1~11",
    ...
    people:["예수님","마리아","제자들","연회장","하인들"],
    summary:"예수님이 가나 혼인잔치에서 물을 포도주로 바꾸신 첫 표적 사건입니다.",
    core:["혼인잔치 초대","포도주 부족","마리아의 요청","물 항아리","좋은 포도주","첫 표적"],
    meaning:["예수님의 첫 표적으로 영광이 드러남","순종을 통해 은혜와 풍성함이 나타남","예수님은 새 기쁨과 새 언약의 주인이심"],
    connect:["혼인잔치","새 포도주","순종","첫 표적","하나님 나라의 기쁨"],
    visual:"갈릴리 가나 위치와 혼인잔치 장면",
    image:"assets/infographics/jesus-1.png"
  },
  "jesus-2":{
    title:"니고데모와의 대화", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 3:1~21",
    ...
    people:["예수님","니고데모","성령","하나님","믿는 자"],
    summary:"예수님이 밤에 찾아온 니고데모에게 거듭남과 영생의 복음을 가르치신 사건입니다.",
    core:["밤의 방문","거듭남 선언","물과 성령","놋뱀 연결","하나님의 사랑","빛과 어둠"],
    meaning:["구원은 혈통이나 지식이 아니라 성령으로 거듭나는 것임","예수님을 믿는 자에게 영생이 주어짐","하나님의 사랑과 복음의 핵심이 드러남"],
    connect:["거듭남","성령","놋뱀","영생","요한복음 3:16"],
    visual:"예루살렘과 밤의 대화 장면",
    image:"assets/infographics/jesus-2.png"
  },
  "jesus-3":{
    title:"사마리아 여인과의 대화", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 4:1~42",
    ...
    people:["예수님","사마리아 여인","제자들","수가성 사람들"],
    summary:"예수님이 사마리아 여인에게 생수와 참된 예배를 가르치시고 사마리아 사람들이 예수님을 구주로 믿게 된 사건입니다.",
    core:["수가성 우물","물 요청","생수 약속","삶의 드러남","참된 예배","마을의 믿음"],
    meaning:["복음은 유대인을 넘어 사마리아와 모든 민족에게 열림","예수님은 영혼의 목마름을 해결하는 생수이심","참된 예배는 장소가 아니라 영과 진리로 드리는 것임"],
    connect:["생수","참된 예배","사마리아","복음 확장","구주"],
    visual:"수가성 야곱의 우물과 사마리아 지역",
    image:"assets/infographics/jesus-3.png"
  },
  "jesus-4":{
    title:"예수님의 이적과 비유들", era:"예수 시대", year:"AD 27~30년경", scripture:"마태복음·마가복음·누가복음·요한복음",
    ...
    people:["예수님","제자들","무리","병자들","종교지도자들"],
    summary:"예수님이 이적과 비유를 통해 하나님 나라의 능력과 의미를 보여주신 사역입니다.",
    core:["치유와 축귀","자연과 생명","공급의 표적","하나님 나라 비유","메시아 표적","믿음의 결단"],
    meaning:["이적은 예수님의 권위와 하나님 나라의 능력을 보여줌","비유는 하나님 나라의 비밀을 일상 언어로 가르침","예수님의 사역은 십자가와 부활을 향해 나아감"],
    connect:["하나님 나라","표적","비유","믿음","메시아"],
    visual:"예수님의 이적과 비유 분류 도식",
    image:"assets/infographics/jesus-4.png"
  },
  "jesus-5":{
    title:"성전 청결 사건", era:"예수 시대", year:"AD 27~30년경", scripture:"요한복음 2:13~22 / 마태복음 21:12~17",
    ...
    people:["예수님","제자들","상인들","환전상들","종교지도자들"],
    summary:"예수님이 성전을 장사하는 곳으로 만든 사람들을 내쫓으시며 성전의 참된 의미를 드러내신 사건입니다.",
    core:["유월절 성전 방문","장사하는 성전","성전 청결","예배 회복 책망","제자들의 기억","참 성전 예고"],
    meaning:["성전은 장사와 이익의 장소가 아니라 기도와 예배의 장소임","예수님은 성전보다 크신 참 성전이심","십자가와 부활을 통해 하나님께 나아가는 길이 열림"],
    connect:["성전","유월절","예배 회복","참 성전","십자가와 부활"],
    visual:"예루살렘 성전과 성전 청결 장면",
    image:"assets/infographics/jesus-5.png"
  }
});
Object.assign(EVENT_ENRICH,{
  "saul-disobedience":{
    flowTitle:"사울왕의 불순종과 버림받음 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["사무엘상 13장","사울이 길갈에서 제사장 권한을 침범함"],
      ["사무엘상 15장","아말렉 사건과 사울의 버림받음"]
    ],
    visualItems:["길갈","아말렉 전쟁","사울의 불순종"]
  },
  "david-fugitive-life":{
    flowTitle:"다윗의 도피생활 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["사무엘상 18~31장","다윗의 도피생활 전체 흐름"],
      ["사무엘상 24장, 26장","다윗이 사울을 살려 줌"]
    ],
    visualItems:["놉","아둘람","엔게디","십 광야","블레셋"]
  },
  "absalom-rebellion":{
    flowTitle:"압살롬의 반역 핵심사건",
    flow:[
      ["가정의 균열","다윗 집안의 죄와 갈등이 깊어짐",""],
    ...
    scriptureRefs:[
      ["사무엘하 13~19장","압살롬의 반역과 다윗의 피난"],
      ["사무엘하 18:33","다윗이 압살롬의 죽음을 슬퍼함"]
    ],
    visualItems:["예루살렘","헤브론","마하나임","에브라임 수풀"]
  },
  "ahab-jezebel-idolatry":{
    flowTitle:"아합왕과 이세벨의 우상숭배 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["열왕기상 16~18장","아합과 이세벨의 바알 숭배 및 갈멜산 대결"],
      ["열왕기상 21장","나봇의 포도원 사건"]
    ],
    visualItems:["사마리아","이스르엘","갈멜산","바알 제단"]
  },
  "naaman-healing":{
    flowTitle:"나아만 장군의 문둥병 치유 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["열왕기하 5장","나아만의 치유와 게하시 사건"],
      ["누가복음 4:27","예수님이 나아만을 언급하심"]
    ],
    visualItems:["아람","사마리아","요단강","엘리사의 집"]
  },
  "cyrus-decree":{
    flowTitle:"고레스 왕의 조서 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["에스라 1:1-4","고레스 왕의 조서"],
      ["역대하 36:22-23","예레미야의 말씀을 이루시는 하나님"]
    ],
    visualItems:["바사 제국","바벨론","예루살렘","귀환 경로"]
  },
  "haggai-zechariah-encouragement":{
    flowTitle:"학개와 스가랴 선지자의 독려 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["에스라 5~6장","학개와 스가랴의 독려로 성전 재건이 재개됨"],
      ["학개 1~2장","성전 재건 촉구와 영광의 약속"],
      ["스가랴 1~8장","회복과 메시아 소망의 환상"]
    ],
    visualItems:["예루살렘","제2성전","스룹바벨","여호수아"]
  },
  "malachi-warning":{
    flowTitle:"말라기 선지자의 경고 핵심사건",
    flow:[
      ["제사 타락 책망","백성들이 더러운 제물과 병든 제물을 드리며 하나님을 경홀히 여김",""],
      ["제사장들의 죄 책망","제사장들이 율법을 지키지 않고 백성을 실족하게 함",""],
      ["언약 불순종 지적","백성들이 하나님과의 언약을 멸시하고 이혼 문제로 책망받음",""],
  ...
  "septuagint-translation":{
    ...
    scriptureRefs:[
      ["신구약 중간기 배경","구약성경의 헬라어 번역과 디아스포라 유대인"],
      ["사도행전 2장","헬라어권 세계로 복음이 확장되는 배경"]
    ],
    visualItems:["알렉산드리아","헬라어권 세계","디아스포라"]
  },
  "herodian-rule-start":{
    flowTitle:"헤롯 왕가의 유대 통치 시작 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["마태복음 2장","헤롯 대왕 시대의 예수 탄생 배경"],
      ["누가복음 1~2장","로마 지배 아래의 유대 배경"]
    ],
    visualItems:["로마 제국","유대","예루살렘","헤롯 성전"]
  },
  "jesus-1":{
    flowTitle:"가나 혼인잔치 핵심사건",
    flow:[
      ["혼인잔치 초대","갈릴리 가나의 혼인잔치에 예수님과 제자들이 초대됨",""],
      ["포도주 부족","잔치 중 포도주가 떨어져 곤란한 상황이 생김",""],
    ...
    scriptureRefs:[
      ["요한복음 2:1~11","가나 혼인잔치와 예수님의 첫 표적"]
    ],
    visualItems:["갈릴리 가나","물 항아리","포도주","첫 표적"]
  },
  "jesus-2":{
    flowTitle:"니고데모와의 대화 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["요한복음 3:1~21","니고데모와 거듭남, 영생의 가르침"]
    ],
    visualItems:["예루살렘","니고데모","거듭남","요한복음 3:16"]
  },
  "jesus-3":{
    flowTitle:"사마리아 여인과의 대화 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["요한복음 4:1~42","사마리아 여인과 생수, 참된 예배"]
    ],
    visualItems:["수가성","야곱의 우물","생수","참된 예배"]
  },
  "jesus-4":{
    flowTitle:"예수님의 이적과 비유들 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["복음서 전체","예수님의 이적과 비유 사역"]
    ],
    visualItems:["이적","비유","하나님 나라","메시아 표적"]
  },
  "jesus-5":{
    flowTitle:"성전 청결 사건 핵심사건",
    flow:[
    ...
    scriptureRefs:[
      ["요한복음 2:13~22","성전 청결과 참 성전 예고"],
      ["마태복음 21:12~17","성전에서 장사하는 자들을 내쫓으심"]
    ],
    visualItems:["예루살렘 성전","환전상","기도의 집","참 성전"]
  }
});
