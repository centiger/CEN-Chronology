...
const CHRONOLOGY_VERSION = "v108-four-axis-visual-emphasis";
...
Object.assign(EVENT_ENRICH,{
  "isaac-rebekah-marriage":{
    ...
    scriptureRefs:[["창세기 24장","이삭과 리브가의 결혼"]],
    visualItems:["하란","우물가","리브가","가나안"]
  },
  "isaac-rebekah":{
    flowTitle:"6. 핵심사건 흐름",
    flow:[
  ...
  "jacob-esau-birthright":{
    ...
    scriptureRefs:[["창세기 25:29-34","야곱과 에서의 팥죽 장자권 사건"]],
    visualItems:["에서의 사냥 후 귀환","팥죽","장자권 이전"]
  },
  "birthright-stew":{
    flowTitle:"6. 핵심사건 흐름",
    flow:[
  ...
  "jacob-egypt-migration":{
    flowTitle:"6. 핵심사건 흐름",
    flow:[
      ["기근의 심화","가나안 땅에 기근이 심해지고 야곱 가족이 양식을 구해야 하는 상황이 됨",""],
      ["요셉의 초청","애굽 총리가 된 요셉이 가족들을 애굽으로 초청함",""],
      ["브엘세바 제사","야곱이 브엘세바에서 하나님께 제사를 드리며 애굽 이주를 앞두고 인도하심을 구함",""],
      ["하나님의 약속","하나님께서 야곱에게 애굽으로 내려가기를 두려워하지 말라고 말씀하심",""],
      ["야곱 가족의 이동","야곱과 그의 모든 가족이 가나안을 떠나 애굽으로 내려감",""],
      ["고센 땅 정착","야곱 가족이 애굽 고센 땅에 정착하여 이스라엘 민족 형성의 토대가 마련됨",""]
    ],
    scriptureRefs:[["창세기 45~46장","요셉의 초청과 야곱 가족의 애굽 이주"]],
    visualItems:["가나안","브엘세바","애굽","고센"]
  },
  "jacob-egypt":{
    flowTitle:"6. 핵심사건 흐름",
    flow:[
...
Object.assign(EVENTS,{
  "isaac-rebekah-marriage":Object.assign({}, EVENTS["isaac-rebekah-marriage"] || {}, {title:"이삭과 리브가의 결혼", core:["배우자 찾기","종의 기도","리브가 만남","가족의 동의","언약 가정 형성"]}),
  "isaac-rebekah":Object.assign({}, EVENTS["isaac-rebekah"] || {}, {title:"이삭과 리브가의 결혼", core:["배우자 찾기","종의 기도","리브가 만남","가족의 동의","언약 가정 형성"]}),
  "jacob-esau-birthright":Object.assign({}, EVENTS["jacob-esau-birthright"] || {}, {title:"야곱과 에서의 팥죽 장자권", core:["에서의 사냥 후 귀환","붉은 죽 요청","야곱의 제안","장자권을 경시한 에서","장자권의 이전","팥죽을 먹은 에서"]}),
  "birthright-stew":Object.assign({}, EVENTS["birthright-stew"] || {}, {title:"야곱과 에서의 팥죽 장자권", core:["에서의 사냥 후 귀환","붉은 죽 요청","야곱의 제안","장자권을 경시한 에서","장자권의 이전","팥죽을 먹은 에서"]}),
  "jacob-egypt-migration":Object.assign({}, EVENTS["jacob-egypt-migration"] || {}, {title:"야곱 가족의 애굽 이주", core:["기근의 심화","요셉의 초청","브엘세바 제사","하나님의 약속","야곱 가족의 이동","고센 땅 정착"]}),
  "jacob-egypt":Object.assign({}, EVENTS["jacob-egypt"] || {}, {title:"야곱 가족의 애굽 이주", core:["기근의 심화","요셉의 초청","브엘세바 제사","하나님의 약속","야곱 가족의 이동","고센 땅 정착"]})
});


// v90 직접복구: 발람 선지자와 말하는 나귀 6.핵심사건 흐름 보정
Object.assign(EVENT_ENRICH,{
  "balaam-donkey":{
    flowTitle:"6. 핵심사건 흐름",
    flow:[
    ...
    scriptureRefs:[
      ["민수기 22~24장","발람과 말하는 나귀, 이스라엘을 향한 축복"],
      ["민수기 24:17","야곱에게서 나올 별과 왕권의 예언"]
    ],
    visualItems:["모압","발람의 길","말하는 나귀","야곱의 별"]
  }
});
...
Object.assign(EVENT_ENRICH, {
  "seven-seals": {
    ...
    scriptureRefs: [
      ["요한계시록 5장", "어린양이 두루마리를 받으심"],
      ["요한계시록 6장", "첫째 인부터 여섯째 인까지 열림"],
      ["요한계시록 8:1", "일곱째 인과 하늘의 침묵"]
    ],
